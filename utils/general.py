...
def colors(index=None):
    # Colors for visualization
    if index is None:
        # Return all colors
        return [[255, 0, 255], [255, 105, 180], [255, 20, 147], [199, 21, 133], 
                [218, 112, 214], [186, 85, 211], [147, 112, 219], [138, 43, 226]]
    else:
        # Return color at specified index with emphasis on magenta/pink family
        magenta_colors = [[255, 0, 255], [255, 105, 180], [255, 20, 147], [199, 21, 133], 
                          [218, 112, 214], [186, 85, 211], [147, 112, 219], [138, 43, 226]]
        return magenta_colors[int(index) % len(magenta_colors)]
